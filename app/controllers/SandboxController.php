...
class SandboxController extends \Phalcon\Mvc\Controller
{

    public function indexAction()
    {

       $f = dirname( __DIR__ ) . '/cli/data/VZFEI/Pages/Data/4641/Реформы Петра 1.rtf';
...
function rtf2text($filename) {
        ...
        switch ($c) {
            ...
            case "\\":
                ...
                elseif ($nc == "'") {
                    ...
                    for ($k = $i + 1, $m = 0; $k < mb_strlen($text); $k++, $m++) {
                        $nc = $text[$k];
    ...
    // Return result.
    return mb_convert_encoding($document,'utf-8','cp1251');
}
