...
class AllDateTime
{
    ...
    public static function format($date_time, $format = false)
    {
        ...
        $datetime = date($format, strtotime($date_time));
    ...
    public static function time_ago($timestamp, $current_time = false)
    {
        ...
        if ($years_ago > 1) {
            ...
            return sprintf('%s %s назад', $years_ago, Text::declension($years_ago, array('год', 'года', 'лет')));
        }
        if ($years_ago == 1) {
        ...
        if ($months_ago > 1) {
            ...
            return sprintf('%s %s назад', $months_ago, Text::declension($months_ago, array('месяц', 'месяца', 'месяцев')));
        }
        if ($months_ago == 1) {
        ...
        if ($weeks_ago > 1) {
            ...
            return sprintf('%s %s назад', $weeks_ago, Text::declension($weeks_ago, array('неделя', 'недели', 'недель')));
        }
        if ($weeks_ago == 1) {
        ...
        if ($days_ago > 1) {
            ...
            return sprintf('%s %s назад', $days_ago, Text::declension($days_ago, array('день', 'дня', 'дней')));
        }
        if ($days_ago == 1) {
        ...
        if ($hours_ago > 1) {
            ...
            return sprintf('%s %s назад', $hours_ago, Text::declension($hours_ago, array('час', 'часа', 'часов')));
        }
        if ($hours_ago == 1) {
        ...
        if ($minutes_ago > 1) {
            ...
            return sprintf('%s %s назад', $minutes_ago, Text::declension($minutes_ago, array('минуту', 'минуты', 'минут')));
        }
        if ($minutes_ago == 1) {
        ...
        if ($seconds_ago > 1) {
            ...
            return sprintf('%s %s назад', $seconds_ago, Text::declension($seconds_ago, array('секунда', 'секунды', 'секунд')));
        }
        if ($seconds_ago <= 1) {
    ...
    public static function time_string($time)
    {
        ...
        if ($years > 1) {
            ...
            return sprintf('%s %s', $years, Text::declension($years, array('год', 'года', 'лет')));
        }
        if ($years == 1) {
        ...
        if ($months > 1) {
            ...
            return sprintf('%s %s', $months, Text::declension($months, array('месяц', 'месяца', 'месяцев')));
        }
        if ($months == 1) {
        ...
        if ($weeks > 1) {
            ...
            return sprintf('%s %s', $weeks, Text::declension($weeks, array('неделя', 'недели', 'недель')));
        }
        if ($weeks == 1) {
        ...
        if ($days > 1) {
            ...
            return sprintf('%s %s', $days, Text::declension($days, array('день', 'дня', 'дней')));
        }
        if ($days == 1) {
        ...
        if ($hours > 1) {
            ...
            return sprintf('%s %s', $hours, Text::declension($hours, array('час', 'часа', 'часов')));
        }
        if ($hours == 1) {
        ...
        if ($minutes > 1) {
            ...
            return sprintf('%s %s', $minutes, Text::declension($minutes, array('минуту', 'минуты', 'минут')));
        }
        if ($minutes == 1) {
